...
// Sample routes data - All routes ₦566 for Interswitch test compatibility
const allRoutes = [
  {
    id: "1",
    driverName: "Chidi O.",
  ...
  // Additional routes covering more cities
  {
    id: "5",
    driverName: "Ibrahim Y.",
    driverRating: 4.6,
    driverPhoto: "",
    vehicleInfo: "Red Toyota Corolla",
    from: "Abuja",
    to: "Kano",
    passingStops: ["Kaduna", "Zaria"],
  ...
  },
  {
    ...
    driverRating: 4.9,
    driverPhoto: "",
    vehicleInfo: "Gray Honda Accord",
    from: "Port Harcourt",
    to: "Enugu",
    passingStops: ["Aba", "Umuahia"],
  ...
  },
  {
    ...
    driverRating: 4.7,
    driverPhoto: "",
    vehicleInfo: "Black Toyota Venza",
    from: "Ibadan",
    to: "Abeokuta",
    passingStops: ["Ifo"],
    departureTime: "6:00 AM",
  ...
  {
    id: "10",
    driverName: "Blessing O.",
    driverRating: 4.9,
    driverPhoto: "",
    vehicleInfo: "Silver Hyundai Sonata",
    from: "Owerri",
    to: "Onitsha",
    passingStops: ["Okigwe"],
    departureTime: "7:00 AM",
