...
import BlockchainBadge from "@/components/rider/blockchain-badge"

export default function EnhancedSearchResults({ results, onBook }: any) {
  ...
  return (
    <>
      <div className="space-y-4">
        {results.map((route: any, index: number) => (
          <Card
            key={route.id}
